...
fetchr.registerService(require("./services/parties"));
fetchr.registerService(require("./services/party"));
fetchr.registerService(require("./services/answers"));
fetchr.registerService(require("./services/answer"));
fetchr.registerService(require("./services/questions"));
fetchr.registerService(require("./services/question"));
fetchr.registerService(require("./services/users"));
fetchr.registerService(require("./services/user"));
fetchr.registerService(require("./services/quizzes"));
fetchr.registerService(require("./services/quiz"));
fetchr.registerService(require("./services/tags"));
fetchr.registerService(require("./services/tag"));
fetchr.registerService(require("./services/settings"));
